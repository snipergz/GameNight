  ...
  return (
    <section className='container mx-auto p-4 h-auto max-w-full md:mt-20'>
        <div className='text-white mx-auto max-w-[1240px] relative'>
            ...
            <Link id="mafia-play-btn" className='block bg-mafiaRed mt-6 lg:mt-12 text-white py-3 px-6 w-[50%] text-center mx-auto border border-navy rounded' to='/mafia/server'>Play Mafia</Link>        
        </div>
    </section>
  );
