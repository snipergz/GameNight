...
const Characters = () => {
  return (
    ...
    >
      ...
      <div className="grid md:grid-cols-3 w-max lg:max-w-[1240px] m-auto text-dark gap-8 sm:gap-2 justify-center">
      ...
      <div className="flex flex-col rounded-lg shadow-lg bg-white max-w-sm">
        ...
        <div className="p-4">
          ...
          <p className="mb-4">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Omnis,
            voluptatibus nemo iste quia delectus tenetur expedita atque deleniti
            placeat animi nulla sint veniam quisquam magnam.
          </p>
        </div>
      </div>
      <div className="flex flex-col rounded-lg shadow-lg bg-white max-w-sm">
