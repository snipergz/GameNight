    ...
    <section className='container mx-auto p-4 h-auto max-w-full md:mt-20'>
          <div className='text-white mx-auto max-w-[1040px] relative'>
            <div>
              ...
              <Link className='block bg-mafiaRed mt-6 lg:mt-12 text-white py-3 px-6 w-[50%] text-center mx-auto border border-navy rounded mb-4' to='/MysteryPlay'>Play Mystery Party</Link>
            </div>
            
            <div>
              <p className='text-xl lg:text-2xl'>Press the button bellow to shuffle the choices you encounter in Mystery Party!</p>
              <Link className='block bg-mafiaRed mt-4 text-white py-3 px-6 w-[50%] text-center mx-auto border border-navy rounded' onClick={e => handleClick(e)}>{shufflebuttontext}</Link>      
            </div>
          </div>
      </section>
  );
