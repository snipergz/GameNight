  ...
  return (
    <section className='container mx-auto p-4 h-auto max-w-full md:mt-20'>
          <div className='text-white mx-auto max-w-[1040px] relative'>
              ...
              <Link className='block bg-mysteryYellow mt-6 lg:mt-12 text-white py-3 px-6 w-[50%] text-center mx-auto border border-navy rounded' to='/mystery/server/play'>Play Mystery Party</Link>        
          </div>
      </section>
  );
